...
(script dormant damage_players
	(sleep_until
		(begin
			...
			(if (!= (volume_test_object current_volume (player_get_by_idx 0)) true) (damage_object_effect barrier_damage (player_get_by_idx 0)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 1)) true) (damage_object_effect barrier_damage (player_get_by_idx 1)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 2)) true) (damage_object_effect barrier_damage (player_get_by_idx 2)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 3)) true) (damage_object_effect barrier_damage (player_get_by_idx 3)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 4)) true) (damage_object_effect barrier_damage (player_get_by_idx 4)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 5)) true) (damage_object_effect barrier_damage (player_get_by_idx 5)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 6)) true) (damage_object_effect barrier_damage (player_get_by_idx 6)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 7)) true) (damage_object_effect barrier_damage (player_get_by_idx 7)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 8)) true) (damage_object_effect barrier_damage (player_get_by_idx 8)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 9)) true) (damage_object_effect barrier_damage (player_get_by_idx 9)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 10)) true) (damage_object_effect barrier_damage (player_get_by_idx 10)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 11)) true) (damage_object_effect barrier_damage (player_get_by_idx 11)) )
			(if (!= (volume_test_object current_volume (player_get_by_idx 12)) true) (damage_object_effect barrier_damage (player_get_by_idx 12)) )
